...
import { FileField,Loader } from '../components'
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className="mt-2 text-[#171718] text-[14px] max-w-[500px]">Create image from dalli ai</p>
      </div>
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        <div className='flex flex-col gap-5'>
          ...
          <FileField
            ...
            type="text"
            name="prompt"
            placeholder="a pencil and watercolor drawing of a "
            value={form.prompt}
            handleChange={handleChange}
            isSurpriseMe
          ...
          <div className="relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
           focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center">
            ...
            {generatingImg && (
              <div className="absolute inset-0 z-0 flex justify-center items-center bg-[rgba(121,116,116,0.5)] rounded-lg">
                <Loader />
              </div>
            )}
          </div>
        ...
        <div className='mt-10'>
          <p className='mt-2 text-[#666e75] text-[14px]'>Once you have created the image you</p>
          <button
            type='submit'
